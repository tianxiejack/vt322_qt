...
{
    int value=continue_ledt_set_azimuth_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x57;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=continue_ledt_set_pitch_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x58;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=continue_ledt_set_zoom_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x59;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
void MainWindow::fixchanelname_Slot_sec(int i)
{
    float value = 0;
    if(i == Qt::Checked){
        value = 1;
...
{
    int value=ledt_set_azimuth_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x57;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=Change_ledt_set_azimuth_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x57;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=ledt_set_pitch_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x58;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=Change_ledt_set_pitch_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x58;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=ledt_set_zoom_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x59;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
...
{
    int value=Change_ledt_set_zoom_sec->text().toInt();
    send_mutex.lock();
    send_arr[4] = 0x59;
    memcpy(send_arr+5,&value,4);
    send_oneframe(5);
