...
//    QPushButton *btn_sersor_continue;
    ...
    MyWidget *w_plat;
     ...
     // QString pid_s[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
      ...
      /*pid配置 通道1*/
          ...
          QLineEdit *kp1_pid,*ki1_pid,*kd1_pid,*k1,*kp2_pid,*ki2_pid,*kd2_pid,*k2;
          QLineEdit *kx_lineEdt,*ky_lineEdt,*errx_lineEdt,*erry_lineEdt,*time_lineEdt;
          QString pid_s[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
          QString dbg_s1[5]={"x轴比例调节系数","y轴比例调节系数","x轴进PID偏差","y轴PID偏差进","进PID时间"};
          int current_1 = 0;
          /*pid配置 通道2*/
          ...
          QLineEdit *kx_lineEdt2,*ky_lineEdt2,*errx_lineEdt2,*erry_lineEdt2,*time_lineEdt2;
          QString pid_s2[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
          QString dbg_s2[5]={"x轴比例调节系数","y轴比例调节系数","x轴进PID偏差","y轴PID偏差进","进PID时间"};
          ...
          QLineEdit *kx_lineEdt3,*ky_lineEdt3,*errx_lineEdt3,*erry_lineEdt3,*time_lineEdt3;
          QString pid_s3[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
          QString dbg_s3[5]={"x轴比例调节系数","y轴比例调节系数","x轴进PID偏差","y轴PID偏差进","进PID时间"};
          ...
          QLineEdit *kx_lineEdt4,*ky_lineEdt4,*errx_lineEdt4,*erry_lineEdt4,*time_lineEdt4;
          QString pid_s4[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
          QString dbg_s4[5]={"x轴比例调节系数","y轴比例调节系数","x轴进PID偏差","y轴PID偏差进","进PID时间"};
          ...
          QLineEdit *kx_lineEdt5,*ky_lineEdt5,*errx_lineEdt5,*erry_lineEdt5,*time_lineEdt5;
          QString pid_s5[8]={"PIDx轴比例系数Kp","PIDx轴积分系数Ki","PIDx轴微分系数Kd","PIDx轴滤波系数k","PIDy比例系数Kp","PIDy积分系数Ki","PIDy微分系数Kd","PIDy轴滤波系数k"};
          QString dbg_s5[5]={"x轴比例调节系数","y轴比例调节系数","x轴进PID偏差","y轴PID偏差进","进PID时间"};
    ...
    *dbg11_lineEdt,*dbg12_lineEdt,*dbg13_lineEdt,*dbg14_lineEdt,*dbg15_lineEdt;
    ...
    QString speed_q[11]={"x轴最大速度","y轴最大速度","x方向死区","y方向死区","输出偏差类型设置","地址","波特率","数据位","停止位","校验位","流控制"};

    /*转台配置通道二*/
    MyWidget *w_speedconv_sec;
    QGroupBox *gbox_speedx_sec,*gbox_speedy_sec;
    QLineEdit *speedx1_lineEdt_sec,*speedx2_lineEdt_sec,*speedx3_lineEdt_sec,*speedx4_lineEdt_sec,*speedx5_lineEdt_sec,*speedx6_lineEdt_sec,*speedx7_lineEdt_sec,*speedx8_lineEdt_sec,*speedx9_lineEdt_sec;
    QLineEdit *speedy1_lineEdt_sec,*speedy2_lineEdt_sec,*speedy3_lineEdt_sec,*speedy4_lineEdt_sec,*speedy5_lineEdt_sec,*speedy6_lineEdt_sec,*speedy7_lineEdt_sec,*speedy8_lineEdt_sec,*speedy9_lineEdt_sec;
    ...
    QString speed_s_sec[9]={"等级1","等级2","等级3","等级4","等级5","等级6","等级7","等级8","等级9"};
    QString speed_q_sec[11]={"x轴最大速度","y轴最大速度","x方向死区","y方向死区","输出偏差类型设置","地址","波特率","数据位","停止位","校验位","流控制"};

    /*转台配置通道三*/
    MyWidget *w_speedconv_thi;
    QGroupBox *gbox_speedx_thi,*gbox_speedy_thi;
    QLineEdit *speedx1_lineEdt_thi,*speedx2_lineEdt_thi,*speedx3_lineEdt_thi,*speedx4_lineEdt_thi,*speedx5_lineEdt_thi,*speedx6_lineEdt_thi,*speedx7_lineEdt_thi,*speedx8_lineEdt_thi,*speedx9_lineEdt_thi;
    QLineEdit *speedy1_lineEdt_thi,*speedy2_lineEdt_thi,*speedy3_lineEdt_thi,*speedy4_lineEdt_thi,*speedy5_lineEdt_thi,*speedy6_lineEdt_thi,*speedy7_lineEdt_thi,*speedy8_lineEdt_thi,*speedy9_lineEdt_thi;
    ...
    QString speed_s_thi[9]={"等级1","等级2","等级3","等级4","等级5","等级6","等级7","等级8","等级9"};
    QString speed_q_thi[11]={"x轴最大速度","y轴最大速度","x方向死区","y方向死区","输出偏差类型设置","地址","波特率","数据位","停止位","校验位","流控制"};

    /*转台配置通道四*/
    MyWidget *w_speedconv_fou;
    QGroupBox *gbox_speedx_fou,*gbox_speedy_fou;
    QLineEdit *speedx1_lineEdt_fou,*speedx2_lineEdt_fou,*speedx3_lineEdt_fou,*speedx4_lineEdt_fou,*speedx5_lineEdt_fou,*speedx6_lineEdt_fou,*speedx7_lineEdt_fou,*speedx8_lineEdt_fou,*speedx9_lineEdt_fou;
    QLineEdit *speedy1_lineEdt_fou,*speedy2_lineEdt_fou,*speedy3_lineEdt_fou,*speedy4_lineEdt_fou,*speedy5_lineEdt_fou,*speedy6_lineEdt_fou,*speedy7_lineEdt_fou,*speedy8_lineEdt_fou,*speedy9_lineEdt_fou;
    ...
    QString speed_s_fou[9]={"等级1","等级2","等级3","等级4","等级5","等级6","等级7","等级8","等级9"};
    QString speed_q_fou[11]={"x轴最大速度","y轴最大速度","x方向死区","y方向死区","输出偏差类型设置","地址","波特率","数据位","停止位","校验位","流控制"};

    /*转台配置通道五*/
    MyWidget *w_speedconv_fif;
    QGroupBox *gbox_speedx_fif,*gbox_speedy_fif;
    QLineEdit *speedx1_lineEdt_fif,*speedx2_lineEdt_fif,*speedx3_lineEdt_fif,*speedx4_lineEdt_fif,*speedx5_lineEdt_fif,*speedx6_lineEdt_fif,*speedx7_lineEdt_fif,*speedx8_lineEdt_fif,*speedx9_lineEdt_fif;
    QLineEdit *speedy1_lineEdt_fif,*speedy2_lineEdt_fif,*speedy3_lineEdt_fif,*speedy4_lineEdt_fif,*speedy5_lineEdt_fif,*speedy6_lineEdt_fif,*speedy7_lineEdt_fif,*speedy8_lineEdt_fif,*speedy9_lineEdt_fif;
    ...
    QString speed_s_fif[9]={"等级1","等级2","等级3","等级4","等级5","等级6","等级7","等级8","等级9"};
    QString speed_q_fif[11]={"x轴最大速度","y轴最大速度","x方向死区","y方向死区","输出偏差类型设置","地址","波特率","数据位","停止位","校验位","流控制"};
    ...
    QString mtd_s[13]={"检测区域中心坐标","检测区域宽高","最多检测个数","模板更新速度","目标像素最大值","目标像素最小值","灵敏度阈值","检测速度","最大跟踪时间","优先级判断","开关量输出","开关量输出极性","报警延时时间"};
